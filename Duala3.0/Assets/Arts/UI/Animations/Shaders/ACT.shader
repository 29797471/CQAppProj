	...
	//	_BumpMap("BumpTex", 2D) = "white"{}
		...
		_BrightnessAmount ("亮度", Range(0.0, 2.0)) = 1.0
		_SaturationAmount ("饱和度", Range(0.0, 1.0)) = 1.0
		_ContrastAmount ("对比度", Range(0.0, 1.0)) = 1.0
		_MetallicX("金属", Range(0.0, 1.0)) = 0.9
		_Smoothness("平滑", Range(0.0, 1.0)) = 0.15
	}
	SubShader {
